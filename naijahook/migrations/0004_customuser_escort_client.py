# Generated by Django 4.2.3 on 2024-02-02 02:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('naijahook', '0003_adsvideos_services'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='naijahook.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='client',
